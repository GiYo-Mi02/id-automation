"""
School ID Automation System - Wardiere Edition (Final Synced Version)
"""
...
CONFIG = {
    ...
    # === ALIGNMENT SETTINGS (Synced with your Template) ===
    # These match the values in your rimberio.template.py
    'NAME_Y': 540,   
    'ROLE_Y': 590,   
...
class SchoolIDProcessor:
    ...
    def apply_template(self, photo, student_data):
        ...
        # --- UPDATED: Uses Config Variables ---
        name_y = self.config['NAME_Y']
        print(f"  DEBUG: Name Y Position = {name_y}") 
        ...
        print(f"  DEBUG: Role Y Position = {role_y}")

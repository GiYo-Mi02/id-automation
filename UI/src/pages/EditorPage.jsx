  ...
  back: {
    ...
    layers: [
      ...
      },
      {
        ...
        type: 'qr_code',
        name: 'QR Code',
        field: type === 'student' ? 'lrn' : (type === 'teacher' ? 'employee_id' : 'id_number'),
        x: 220,
        y: 700,
        width: 150,
        height: 150,
...
export default function EditorPage() {
  ...
  const handleAddLayer = useCallback((type) => {
    const newLayer = {
      ...
      field: type === 'text' ? 'static' : type === 'image' ? 'photo' : type === 'qr_code' ? (templateType === 'student' ? 'lrn' : (templateType === 'teacher' ? 'employee_id' : 'id_number')) : null,
      x: 100,
      y: 100,
